...
sub encode {
	...
	$str =~ tr
		[\x{ff5e}\x{00ab}\x{00bb}\x{00b7}\x{00a0}\x{ff0d}\x{2010}\x{2011}\x{2012}\x{2013}\x{3099}\x{309a}]
		[\x{301c}\x{226a}\x{226b}\x{30fb}\x{0020}\x{002d}\x{002d}\x{002d}\x{002d}\x{002d}\x{309b}\x{309c}];
