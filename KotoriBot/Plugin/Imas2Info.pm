...
my $idollist = [
	...
	[ "天海",   "amami",     "春香",   "haruka",  17, 158, "不明", "4月3日",    "O", 83, 56, 82, undef, "おかし作り、カラオケ、長電話", "中村繪里子" ],
	[ "如月",   "kisaragi",  "千早",   "chihaya", 16, 162, "不明", "2月25日",   "A", 72, 55, 78, undef, "音楽鑑賞（クラシック）、トレーニング", "今井麻美" ],
	[ "萩原",   "hagiwara",  "雪歩",   "yukiho",  17, 155, "不明", "12月24日",  "A", 81, 56, 81, undef, "MY詩集を書くこと、日本茶、ブログ", "浅倉杏美" ],
	[ "高槻",   "takatsuki", "やよい", "yayoi",   14, 145, "不明", "3月25日",   "O", 74, 54, 78, undef, "オセロ、野球、家庭菜園", "仁後真耶子" ],
	[ "秋月",   "akizuki",   "律子",   "ritsuko", 19, 156, "不明", "6月23日",   "A", 85, 57, 85, undef, "資格取得、分析・実践、ボランティア", "若林直美" ],
	[ "三浦",   "miura",     "あずさ", "azusa",   21, 168, "不明", "7月19日",   "O", 91, 59, 86, undef, "犬の散歩、カフェ巡り", "たかはし智秋" ],
	[ "水瀬",   "minase",    "伊織",   "iori",    15, 153, "不明", "5月5日",   "AB", 77, 54, 79, undef, "海外旅行、食べ歩き", "釘宮理恵" ],
	[ "菊地",   "kikuchi",   "真",     "makoto",  17, 159, "不明", "8月29日",   "O", 75, 57, 78, undef, "スポーツ全般、ぬいぐるみ集め", "平田宏美" ],
	[ "双海",   "futami",    "亜美",   "ami",     13, 158, "不明", "5月22日",   "B", 78, 55, 77, undef, "メール、エコ", "下田麻美" ],
	[ "双海",   "futami",    "真美",   "mami",    13, 158, "不明", "5月22日",   "B", 78, 55, 77, undef, "メール、ゲーム", "下田麻美" ],
	[ "星井",   "hoshii",    "美希",   "miki",    15, 161, "不明", "11月23日",  "B", 86, 55, 83, undef, "友達とおしゃべり、ネイルアート", "長谷川明子" ],
	[ "我那覇", "ganaha",    "響",     "hibiki",  16, 152, "不明", "10月10日",  "A", 83, 56, 80, undef, "編み物、卓球、散歩", "沼倉愛美" ],
	[ "四条",   "shijou",    "貴音",   "takane",  18, 169, "不明", "1月21日",   "B", 90, 62, 92, undef, "天体観測、歴史", "原由実" ],
];
my $name_map = {};
my $name_match;
