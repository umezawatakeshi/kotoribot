...
my $idollist = [
	...
	[ "日高",   "hidaka",    "愛",     "ai",      13, 149, 40, "6月25日",   "O", 78, 55, 79, undef, "バーゲンの1点買い、金魚すくい", "戸松遥" ],
	[ "水谷",   "mizutani",  "絵理",   "eri",     15, 152, 36, "3月7日",    "B", 82, 53, 76, undef, "映像編集、ジグソーパズル", "花澤香菜" ],
	[ "秋月",   "akizuki",   "涼",     "ryo",     15, 162, 54, "9月15日",   "O", 80, 59, 80, undef, "掃除とかお料理とか", "三瓶由布子" ],
